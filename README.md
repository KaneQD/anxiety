...
**A:** Ano, stejně jako můžeš tvrdit že si napsal Frankensteina Mary Shelley, nebo že máš šest krvácejícíh chlupatých bradavic.
...
**Q:** Můžu prodat port této hry?    
**A:** Ano! Ale pro vyhnutí se zbytečnému zmatku, prosím označ to jako "Fan-Made Port", ideálně i s *odkazem k tomuto vyjádření které explicitně povoluje komerční užití*. (Příklad: [Steam verze jedné mé další hry!](https://store.steampowered.com/app/1103210/We_Become_What_We_Behold_FanMade_Port/)) Toto je pro vyhnutí obvinění z krádeže od lidí kteří si nejsou vědomi, že vždy dělám své díla open-source + public-domain.
